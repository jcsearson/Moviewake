			...
			<div class="primary">
				<article class="archive">
					<h1>All Time Favorites:</h1>
						<ul class="hits">
						<?php $allFilms = new WP_Query(array(  //makes WP_query object and stores in variable  $films
							'post_type' => 'films',  //tells WP that we want posts that are from the custom post type 'film'
						)); ?>

						<?php if ($allFilms->have_posts()) : ?>
						<?php while($allFilms->have_posts()) : $allFilms->the_post(); ?>
							<li>
						                  <h2>
